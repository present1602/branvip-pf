export function createMailHtml ({name , type, subject, text}){
    return `<!DOCTYPE html>
<html lang="ko">
  <head>
  <title></title>
    ...
    <tr>
      ...
      <a  id="myLink" href="https://www.branvip.com">
        <img id="myImage"  class="image-style" src="https://branvip.dooray.com/drive/v1/downloads/3257992129857003896/3747936684348624791?"  alt="logo" onclick="return false;">
          ...
          <div class="font-details">${name} 님, <br>문의가 정상적으로 접수되었습니다.</div>
      </td>
    </tr>
  </table>
</div>
<div class="container">
  <table class="info-table">
    <tr>
      <td class="info-cell info-cell-title">문의유형</td>
      <td class="info-cell info-cell-content">${type}</td>
    </tr>
    <tr>
      <td class="info-cell info-cell-title">문의제목</td>
      <td class="info-cell info-cell-content">${subject}</td>
    </tr>
    <tr>
      <td class="table-cell info-cell-title" colspan="2">문의내용</td>
    </tr>
    <tr>
      <td class="info-cell info-cell-content" colspan="2">${text}</td>
    </tr>
  </table>
</div>
<div class="container">
