...
export function ButtonLite({ size = "sm", outline, ...props }: ButtonProps) {
  const {
    leftIcon,
    rightIcon,
    children,
  ...
  const variantClass = {
    solid:
      " bg-white text-surface-600 hover:bg-primary-400 disabled:bg-surface-100 disabled:text-surface-300 border",
    outline:
